...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AspectoPlanta_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_AspectoPlanta;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APlant_Statics::NewProp_AspectoPlanta_MetaData[] = {
		{ "Category", "Plant" },
		{ "Comment", "//Cambiando apariencia\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Plant.h" },
		{ "ToolTip", "Cambiando apariencia" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APlant_Statics::NewProp_AspectoPlanta = { "AspectoPlanta", nullptr, (EPropertyFlags)0x0020080000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APlant, AspectoPlanta), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_APlant_Statics::NewProp_AspectoPlanta_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APlant_Statics::NewProp_AspectoPlanta_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APlant_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APlant_Statics::NewProp_AspectoPlanta,
	};
	...
	IMPLEMENT_CLASS(APlant, 3672952293);
